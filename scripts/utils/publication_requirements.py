...
CATEGORY_A_PUBLICATIONS: list[dict] = [
    ...
    # 26. International Grain Code (duplicate of #19 — kept as distinct entry per spec)
    # Note: #19 already covers Grain Code. This entry is an alias.
    # Skipped to avoid duplication. Merged into PUB_A_019.

    # 27. NOx Technical Code
    {
        "publication_id": "PUB_A_027",
    ...
    # IMSBC Code (bonus — exists in convention rules)
    {
        "publication_id": "PUB_A_028",
