  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">管理者ビュー — 全船規制サマリー</h1>
        <Link
          href="/fleet"
      ...
      {/* サマリーバー */}
      <div className="rounded border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 p-4 mb-6">
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {group.ships.map((ship) => (
                    <span
                      key={ship.id}
                      className="inline-block rounded bg-blue-50 dark:bg-blue-950 px-2 py-0.5 text-xs text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800"
                    >
                      {ship.ship_name} (
