      ...
      <div className="motion-preset-fade rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-800 p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 hover:scale-[1.02] transition-transform disabled:opacity-50"
          >
            この船舶を削除
          </button>
        </form>
