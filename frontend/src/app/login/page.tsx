...
function LoginForm() {
  ...
  return (
    <div className="flex flex-1 items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-6 rounded-xl border border-zinc-200 border-t-4 border-t-blue-600 p-6 shadow-lg dark:border-zinc-800 dark:border-t-blue-600 motion-preset-fade motion-duration-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {!isSignUp && (
              <button
                ...
                className="mt-1 text-xs text-zinc-500 hover:text-blue-600 hover:underline"
              >
                パスワードを忘れた場合
              </button>
            )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition-transform hover:scale-[1.02] hover:bg-blue-700 disabled:opacity-50"
          >
            {loading
              ? "処理中..."
              : isSignUp
