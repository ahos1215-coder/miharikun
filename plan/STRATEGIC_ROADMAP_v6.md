...
### フェーズ 1: 情報の集約と鮮度維持 ✅ 完了 (2026-04-03)
- NK 99件 + MLIT 18件 収集済み、品質検証合格
- 備付書籍81冊マスター投入済み + 海文堂/成山堂/IMO/JHA 月次自動チェック
- ノイズフィルタ v2.4 (351パターン) + F-D-H Self-Critique 稼働中
...
| スクリプト | 用途 | スケジュール |
|-----------|------|------------|
| `scrape_nk.py` | NK 週次取得 (100件, --force-all対応) | 週次 日曜 07:00 |
...
| `check_publication_updates.py` | 書籍版数チェック (IMO/JHA/海文堂/成山堂) | 月次 1日 |
| `seed_publications.py` | 書籍マスターデータ投入 (81冊) | GHA手動実行 |
