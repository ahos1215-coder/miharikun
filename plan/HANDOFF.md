...
**Phase 3 作業中・本番稼働中。Vibe OS + Maritime Command Center + 法定図書自動マッピング 実装済み。** https://miharikun.vercel.app
...
マイグレーション: `supabase/migrations/` (10 ファイル、全て適用済み)
...
4. `plan/MARITIME_PROJECT_BLUEPRINT_v4.md` — 技術詳細 (v5/v6 と矛盾する場合はそちら優先)
...
│       ├── publication_requirements.py    # 備付書籍自動判定 (67書籍, 4カテゴリ)
...
├── .github/workflows/                     # GitHub Actions (14)
...
├── supabase/migrations/                   # DB マイグレーション (10ファイル、全適用済み)
